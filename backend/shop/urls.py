...
urlpatterns = [
    ...
    path("admin/media-search/categories", views.admin_media_search_categories_view),
    path("admin/media-search/products", views.admin_media_search_products_view),
    path("admin/media-search/categories/<uuid:category_id>/apply", views.admin_media_search_apply_category_view),
    path("admin/media-search/products/<uuid:product_id>/apply", views.admin_media_search_apply_product_view),
